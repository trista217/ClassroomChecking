...
//}
	...
	public String RoomInfoByRoomID (String field, String roomID)
	{
		...
		//Log.v("roomID", roomID);
		String sql = "Select "+field+" FROM "+DATABASE_NAME+" WHERE room = ? ";
		Cursor c = db.rawQuery(sql, new String[] {roomID});
		//Cursor c = db.rawQuery("Select ClassroomName FROM Classroom WHERE room = \"SD112\"", null);
		c.moveToFirst();
...
//		}
	...
	public ArrayList<Record> RoomDateToRecordList (String roomID, String StartDate, String EndDate){
		...
		//Log.v("roomdatetorecordlist",sql);
